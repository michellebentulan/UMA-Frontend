      ...
      <LivestockCard
        userImage={
          item.user?.profile_image
            ? `http://192.168.69.149:3000/uploads/profile-images/${item.user.profile_image}`
            : "http://192.168.69.149:3000/uploads/profile-images/default.png" // Fallback to a default image
        }
            ...
            onPress: async () => {
              try {
                ...
                if (sessionToken) {
                  ...
                  await axios.put(
                    "http://192.168.69.149:3000/users/expire-session",
                    {
                      sessionToken,
                    }
                  );
