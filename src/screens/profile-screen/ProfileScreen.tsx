        ...
        if (userData) {
          ...
          if (userData.town && userData.barangay) {
            ...
            const locationResponse = await axios.get(
              `http://192.168.74.149:3000/locations?town=${userData.town}&barangay=${userData.barangay}`
            );
  ...
  const fetchUserListings = async (userId: string) => {
    ...
    try {
      ...
      const sellResponse = await axios.get(
        `http://192.168.74.149:3000/livestock-listings?userId=${userId}`
      );
      ...
      const requestedResponse = await axios.get(
        `http://192.168.74.149:3000/requested-listings?userId=${userId}`
      );
