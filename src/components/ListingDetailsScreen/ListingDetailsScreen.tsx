    ...
    const fetchListingDetails = async () => {
      ...
      try {
        const response = await axios.get(
          `http://192.168.74.149:3000/livestock-listings/${listingId}`
        );
        ...
        const locationResponse = await axios.get(
          `http://192.168.74.149:3000/locations?town=${response.data.user.town}&barangay=${response.data.user.barangay}`
        );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.userInfoContainer}>
          <Image
            source={{
              uri: `http://192.168.74.149:3000/uploads/profile-images/${listing.user.profile_image}`,
            }}
